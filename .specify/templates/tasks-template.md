...
**Tests**: 测试是宪章强制门禁。每个故事必须包含适用的单元、共享 ABI 契约和特权内核集成测试。
...
- 每个阶段末尾必须包含验证任务和独立 Git commit 任务
- eBPF/unsafe/兼容处理任务必须包含中文安全注释与文档任务
...
- [ ] T002 Initialize Rust Cargo workspace with Aya dependencies
- [ ] T003 [P] Configure rustfmt, strict Clippy, test and eBPF build tools
- [ ] T004 Verify setup commands and create the setup milestone Git commit
...
- [ ] T005 Define versioned no_std shared event ABI and contract tests
- [ ] T006 [P] Define bounded eBPF maps, event loss counters and resource limits
- [ ] T007 [P] Implement user-space lifecycle, capability and graceful cleanup framework
- [ ] T008 Configure structured logging and operational metrics
- [ ] T009 Setup validated configuration and sensitive-field policy
- [ ] T010 Run foundational gates and create the foundation milestone Git commit
...
- [ ] TXXX Run formatting, Clippy, unit, ABI and privileged integration tests for US1
- [ ] TXXX Create the US1 milestone Git commit after all gates pass
...
- [ ] TXXX Run applicable quality gates for US2
- [ ] TXXX Create the US2 milestone Git commit after all gates pass
...
- [ ] TXXX Run applicable quality gates for US3
- [ ] TXXX Create the US3 milestone Git commit after all gates pass
...
- [ ] TXXX Create the release milestone Git commit after all gates pass
...
- Commit after every validated milestone; never combine unverified milestones
