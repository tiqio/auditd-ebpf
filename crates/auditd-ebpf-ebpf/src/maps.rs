...
pub use auditd_ebpf_common::counters::{
    ...
    COUNTER_EXEC_ARGV_DROPPED, COUNTER_INFLIGHT_DROPPED, COUNTER_INTERNAL_DROPPED,
    COUNTER_PERMISSION_CLASSIFICATION_FAILED, COUNTER_RINGBUF_DROPPED, EVENT_COUNTER_SLOTS,
};
